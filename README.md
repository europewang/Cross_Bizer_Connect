...
#### 5. 配置脚本工具 - 参数
这是最关键的一步，您需要在这里定义脚本的输入参数。请按照下面的说明添加三个参数：
...
6. 点击 **OK**，脚本将执行并直接在输入要素类中添加生成的贝塞尔曲线

## 参数说明

| 参数 | 类型 | 范围 | 默认值 | 说明 |
|------|------|------|--------|---------|
| 输入线要素 | Feature Set | - | - | 需要连接的线要素集合，生成的贝塞尔曲线将直接添加到此要素类中 |
| 曲线饱满度 | Double | 0.1-1.0 | 0.5 | 控制曲线的弯曲程度，值越大越弯曲 |
| 曲线平滑度 | Long | 2-200 | 20 | 控制曲线的点密度，值越大越平滑 |
